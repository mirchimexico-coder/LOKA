...
| **Partner capital still to be paid in** (Kashi $18,432 as of 22-Sep-2026) | Owed to **CAPITAL** (company account), no longer to Lohith. Capital sheet Section G / L C163; dashboard card says "Owes Capital". When he pays: raise D42 by the amount (so funds-in stays right) **and** C169 by the same amount (it lands in the reserve, "with me" stays 0). |
