...
CFG = dict(
    ...
    cash_adjust=-1166.0,                # transfers to Lohith (Jun18 $400 + Jun19 $120) + Jun3 $178 reimbursement + ~$468 MP commission drift on post-15-Jun card sales (clears on next physical count)
